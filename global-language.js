(() => {
  ...
  const L = {
    ...
    ar: {f:"🌍",n:"العربية",d:"rtl",a:"وصول مجاني",choose:"اختر لغة القراءة",close:"إغلاق الإشعار",k:"فتح المقال كاملاً",h:"كيف ترغب في متابعة القراءة؟",lead:"اختر لغة القراءة. يظل التحليل الكامل متاحاً مجاناً للجميع.",story:"موضوع الغلاف",min:"8 دقائق",src:"مصادر مفتوحة",free:"متابعة القراءة مجاناً",member:"انضم إلى VoiceOpenGov وشارك",fine:"لا يلزم دفع أو تسجيل. العضوية تدعم العمل ولا تجعل المعرفة خدمة مدفوعة.",more:"لغات أخرى",rt:"هل تبدو لك هذه النافذة مألوفة؟",r1:"لا ينبغي ربط المعرفة ذات الأهمية المجتمعية بحاجز وصول مصطنع. يحتاج العمل التحريري الجاد إلى تمويل، لكن المصادر والسياق والمعلومات المهمة ديمقراطياً لا ينبغي أن تكون متاحة فقط لمن يدفع.",r2:"لذلك يبقى Vote4Gov مجانياً للجميع. عضوية VoiceOpenGov تعني الدعم والمشاركة، لا شراء الوصول إلى المعلومات.",open:"فتح المقال كاملاً",ps:"لا حاجة للموافقة على التتبع.",p1:"لا تستخدم هذه النسخة من Vote4Gov ملفات تعريف ارتباط للتحليل أو الإعلان أو التتبع، ولا تنشئ ملفات سلوكية ولا تبيع بيانات الاستخدام. قد تنتج بيانات تقنية ضرورية للاستضافة والأمان، ويتم وصفها بشفافية.",p2:"يتطلب استخدام البيانات غير الضروري موافقة منفصلة ومحددة ونشطة يمكن سحبها بالسهولة نفسها.",plink:"مراجعة الخصوصية",cont:"متابعة القراءة",coverage:"تتغير الواجهة والمعاينة تلقائياً. تبقى المقالات الكاملة موضحة بلغتها الأصلية إلى أن تُنشر الترجمة الخاصة بها.",pt:"يتغير مجتمعنا كل يوم. لماذا لا يستطيع سياسياً الرد عادة إلا كل بضع سنوات؟",pp:["ننتخب حزمًا سياسية، ونجيب عن أسئلة محددة مسبقًا، ونتعرف إلى المزاج العام من خلال العناوين والعينات المحدودة.","يفحص Vote4Gov كيف نشأ هذا النظام وما الذي حققه ولماذا يجب أن تتطور آليات التغذية الراجعة الديمقراطية اليوم.","السؤال ليس ما إذا كانت البرلمانات أو وسائل الإعلام أو استطلاعات الرأي يجب أن تختفي، بل لماذا تحدد وحدها تقريبًا كيف تصبح الإرادة العامة مرئية."],nav:{"Titelseite":"الصفحة الرئيسية","Quellen & Methode":"المصادر والمنهج","KI-Transparenz":"شفافية الذكاء الاصطناعي","Korrektur":"التصحيحات","Kontakt":"الاتصال","Ressorts":"الأقسام"}},
    it: {f:"🇮🇹",n:"Italiano",d:"ltr",a:"Accesso libero",choose:"Scegli la lingua di lettura",close:"Chiudi avviso",k:"Apri l’articolo completo",h:"Come vuoi continuare a leggere?",lead:"Scegli la lingua di lettura. L’analisi completa resta liberamente accessibile a tutti.",story:"Storia di copertina",min:"8 minuti",src:"Fonti aperte",free:"Continua gratuitamente",member:"Unisciti a VoiceOpenGov e partecipa",fine:"Non sono richiesti pagamento o registrazione. L’adesione sostiene il lavoro ma non sblocca conoscenza.",more:"Altre lingue",rt:"Questa richiesta ti sembra familiare?",r1:"La conoscenza socialmente rilevante non dovrebbe essere legata a una barriera artificiale. Il lavoro editoriale richiede finanziamento, ma fonti, contesto e informazioni democraticamente importanti non dovrebbero essere riservati a chi paga.",r2:"Vote4Gov resta quindi gratuito per tutti. L’adesione a VoiceOpenGov significa sostegno e partecipazione, non acquisto di accesso alle informazioni.",open:"Apri l’articolo completo",ps:"Non è richiesto il consenso al tracciamento.",p1:"Questa edizione di Vote4Gov non usa cookie di analisi, pubblicità o tracciamento, non crea profili comportamentali e non vende dati di utilizzo. Possono comunque essere generati dati tecnici necessari per hosting e sicurezza, descritti in modo trasparente.",p2:"L’uso non essenziale dei dati richiede un consenso separato, specifico e attivo, revocabile con la stessa facilità.",plink:"Controlla la privacy",cont:"Continua a leggere",coverage:"L’interfaccia e l’anteprima cambiano automaticamente. Gli articoli completi restano chiaramente contrassegnati nella lingua originale finché la traduzione non viene pubblicata.",pt:"La società cambia ogni giorno. Perché politicamente può rispondere di solito solo ogni pochi anni?",pp:["Scegliamo pacchetti politici, rispondiamo a domande predefinite e conosciamo l’umore pubblico attraverso titoli e campioni limitati.","Vote4Gov esamina come questo ordine è nato, cosa ha ottenuto e perché il feedback democratico deve continuare a evolvere.","La domanda non è se parlamenti, media o sondaggi debbano scomparire, ma perché quasi solo loro determinano come diventa visibile la volontà sociale."],nav:{"Titelseite":"Prima pagina","Quellen & Methode":"Fonti e metodo","KI-Transparenz":"Trasparenza IA","Korrektur":"Correzioni","Kontakt":"Contatto","Ressorts":"Sezioni"}},
    pt: {f:"🇵🇹",n:"Português",d:"ltr",a:"Acesso livre",choose:"Escolher idioma de leitura",close:"Fechar aviso",k:"Abrir artigo completo",h:"Como quer continuar a ler?",lead:"Escolha o idioma de leitura. A análise completa continua livremente acessível a todas as pessoas.",story:"Matéria de capa",min:"8 minutos",src:"Fontes abertas",free:"Continuar gratuitamente",member:"Juntar-se à VoiceOpenGov e participar",fine:"Não é necessário pagamento nem registo. A adesão apoia o trabalho, mas não desbloqueia conhecimento.",more:"Mais idiomas",rt:"Este pedido parece-lhe familiar?",r1:"Conhecimento socialmente relevante não deve estar ligado a uma barreira artificial. O trabalho editorial exige financiamento, mas fontes, contexto e informação democraticamente importante não devem ser reservados apenas a quem paga.",r2:"Vote4Gov continua por isso gratuito para todas as pessoas. A adesão à VoiceOpenGov significa apoio e participação, não comprar acesso à informação.",open:"Abrir artigo completo",ps:"Não é necessário consentimento para rastreamento.",p1:"Esta edição do Vote4Gov não utiliza cookies de análise, publicidade ou rastreamento, não cria perfis comportamentais e não vende dados de utilização. Dados técnicos necessários para alojamento e segurança podem ainda existir e são descritos de forma transparente.",p2:"O uso não essencial de dados exige consentimento separado, específico e ativo, que possa ser retirado com a mesma facilidade.",plink:"Ver privacidade",cont:"Continuar a ler",coverage:"A interface e a pré-visualização mudam automaticamente. Os artigos completos permanecem identificados no idioma original até a respetiva tradução ser publicada.",pt:"A sociedade muda todos os dias. Porque é que politicamente só pode responder normalmente de poucos em poucos anos?",pp:["Elegemos pacotes políticos, respondemos a perguntas predefinidas e conhecemos o sentimento público através de títulos e amostras limitadas.","Vote4Gov analisa como esta ordem surgiu, o que alcançou e porque o feedback democrático precisa agora de continuar a evoluir.","A questão não é se parlamentos, media ou sondagens devem desaparecer, mas porque são quase só eles que determinam como a vontade social se torna visível."],nav:{"Titelseite":"Página inicial","Quellen & Methode":"Fontes e método","KI-Transparenz":"Transparência de IA","Korrektur":"Correções","Kontakt":"Contacto","Ressorts":"Secções"}},
  ...
  let code = codes.includes(read()) ? read() : "de";
  let scheduled = false;
  let observer;
  ...
  const header = () => {
    ...
    wrap.dataset.languageUi = "canonical";
  ...
  const dialog = (lang) => {
    ...
    text(top[1], lang.src);
    text(d.querySelector("[data-access-close]"), lang.close);
    languageControls(d, lang);
    text(d.querySelector("[data-preview-kicker]"), lang.story);
    text(d.querySelector("[data-preview-title]"), lang.pt);
    const paragraphs = d.querySelectorAll("[data-preview-text] p");
    paragraphs.forEach((p, i) => text(p, lang.pp[i] || ""));
    const meta = d.querySelectorAll(".editorial-preview-meta span");
    text(meta[0], ISSUE); text(meta[1], lang.min); text(meta[2], lang.src);
    const note = d.querySelector("[data-language-coverage]");
    if (note) text(note, lang.coverage);
    text(d.querySelector("[data-access-free]"), lang.free);
    text(d.querySelector(".editorial-access-fineprint"), lang.fine);
    text(d.querySelector('[data-access-stage="preview"] .editorial-access-actions a'), lang.member);
